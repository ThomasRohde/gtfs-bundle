...
* **created**: Created GTFS Schedule data catalog bundle from the official GTFS Schedule Reference revision marked April 27, 2026; generated 32 table concepts, 7 metric concepts, 10 business-term concepts, 1 dataset concept, and 4 architectural decisions with bundle-relative join links.

- Created GTFS Schedule data catalog from the official Schedule Reference revision marked April 27, 2026.
- Generated 32 table concepts, 7 metric concepts, 10 business-term concepts, one dataset concept, and 4 architectural decisions.
